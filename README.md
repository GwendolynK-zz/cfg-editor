...
**if your running on a mac, you have to use cfg_editor_osx_vX.X DO NOT RUN cfg_editor_vX.X ON MAC** <br>
**if your running linux like system, then use the cfg_editor_vX.X** <br>
